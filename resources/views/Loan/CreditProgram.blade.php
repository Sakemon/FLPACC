...
<!-- <div class="row" > -->
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="margin-top:10px; margin-bottom:10px; height:100%; weight:100%; overflow-y">
      <div class="x_content" >
        <a><center><img src={{($plafond->linkPlafond)}} width="400px;" class="img-responsive"/></center></a>
        ...
        <br />
        {!! Form::open(['url' => 'LoanCustomer','class'=>'form-horizontal form-label-left input_mask','method'=>'GET']) !!}
        <div class="col-xs-12 col-lg-8">
          <div class="form-group" style="margin-top:0px;">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: center;">Funding</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" name="number" class="form-control" id="number" value="Rp {{number_format($plafond->namaPlafond, 2) }}" placeholder="Pencairan" required disabled>
              {{ Form::hidden('plafond', $plafond->idPlafond , array('placeholder'=>'Nama Departemen', 'class' => 'form-control', 'readonly')) }}
            </div>
          </div>

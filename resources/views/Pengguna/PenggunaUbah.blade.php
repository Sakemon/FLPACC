            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <br />
                    {{Form::model($petugas, array('route'=>array('Petugas.update', $petugas->id_petugas),'class'=>'form-horizontal form-label-left input_mask'))}}
                      <div class="col-xs-6">
                          <div class="form-group" style="margin-top:20px;">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              {{ Form::text('nama_petugas', Input::old('nama_petugas'), array('class' => 'form-control')) }}
                            </div>
                          </div>
                          <div class="form-group" style="margin-top:20px;">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              {{ Form::email('email_petugas', Input::old('email_petugas'), array('class' => 'form-control')) }}
                            </div>
                          </div>
                          <div class="form-group" style="margin-top:20px;">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Username</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              {{ Form::text('username_petugas', Input::old('username_petugas'), array('class' => 'form-control')) }}
                            </div>
                          </div>
